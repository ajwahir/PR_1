...
datapath = '/home/ajwahir/acads/pr/assignment/Dataset_Assignment1/Dataset-2_real_world/c_Isolated word recognition/'

classpath.append(join(datapath,'six/'))
classpath.append(join(datapath,'nine/'))
classpath.append(join(datapath,'five/'))
classpath.append(join(datapath,'three/'))
